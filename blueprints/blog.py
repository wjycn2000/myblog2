...
def index():
    ...
    return render_template('front/index.html', posts=posts, pagination=pagination)
...
def show_category(category_id):
    ...
    posts = pagination.items
    return render_template('front/category.html', category=category, pagination=pagination, posts=posts)
